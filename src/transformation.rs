...
mod tests {
    ...
    fn multiplying_translation_matrix() {
        ...
        assert_eq!(transform.matrix() * p, new_point(2.0, 1.0, 7.0));
    }
    ...
    fn scaling_matrix_to_point() {
        ...
        assert_eq!(transform.matrix() * p, new_point(-8.0, 18.0, 32.0));
    }
    ...
    fn scaling_matrix_to_vector() {
        ...
        assert_eq!(transform.matrix() * v, new_vector(-8.0, 18.0, 32.0));
    }
    ...
    fn reflection_is_scaling_by_negative() {
        ...
        assert_eq!(transform.matrix() * p, new_point(-2.0, 3.0, 4.0));
    }
    ...
    fn rotating_point_around_x_axis() {
        ...
        assert_eq!(full_quarter.matrix() * p, new_point(0.0, 0.0, 1.0));
    }
    ...
    fn rotating_point_around_y_axis() {
        ...
        assert_eq!(full_quarter.matrix() * p, new_point(1.0, 0.0, 0.0));
    }
